...
def get_invest_data():
  ...
  5: [# 1. 밸런스 게임: 개별주식 집중 vs ETF 분산
    {   "type": "balance", "id": 115,
        "q": "1,000만원을 지금 투자해야 한다면?",
        "opt": ["A: 내가 잘 아는 개별주식 1개에 집중",
                "B: 시장 전체를 담은 ETF에 분산"]    },
    #  2. 퀴즈: 주식의 총수익률
    # [근거] 총수익률 = (매도가격 - 매수가격 + 배당금) / 매수가격
    {  "type": "quiz", "id": 116,
        "q": "10,000원에 산 주식을 11,000원에 팔고 배당금 200원을 받았다. 총수익률은?",
        "opt": ["10%","11%","12%","20%"],
        "ans": "12%"    },
    # 3. 퀴즈: 시타델 사례의 해석
    {   "type": "quiz", "id": 117,
        "q": "시타델과 반도체 급락 사례를 해석하는 방식으로 가장 적절한 것은?",
        "opt": ["시타델이 의도적으로 급락을 만들었다고 단정해도 됨.",
                "PER이 3~4배였으므로 기업가치 분석은 필요 없고 무조건 매수해야 함.",
                "확인된 사실과 의혹을 구분하고, 단기 가격에서는 수급·유동성 압력이 기업가치 판단을 압도할 수 있음을 이해해야 함.",
                "수급이 풀렸다는 말은 기업의 미래 현금흐름이 자동으로 좋아졌다는 뜻임."],
        "ans": "확인된 사실과 의혹을 구분하고, 단기 가격에서는 수급·유동성 압력이 기업가치 판단을 압도할 수 있음을 이해해야 함."},
    # 4. 퀴즈: ETF의 괴리율
    # [정답] 2% 프리미엄
    # [근거] 괴리율 = (시장가격 - NAV) / NAV
    #        = (10,200 - 10,000) / 10,000 = 2%
    {   "type": "quiz", "id": 118,
        "q": "ETF의 시장가격이 10,200원, NAV가 10,000원이라면?",
        "opt": ["2% 프리미엄","2% 디스카운트", "추적오차 2%","배당수익률 2%"],
        "ans": "2% 프리미엄"  }
]        
